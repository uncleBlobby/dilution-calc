...
const App = () => {
    ...
    return (
        <div className="App">
                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                onChange={(event) => handleVolumeInput(event)}
                            />{" "}
                            liters
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input
                                id="ABVInput"
                                className="digitInput"
                                onChange={(event) => handleABVInput(event)}
                            />{" "}
                            %
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input
                                id="targetABVInput"
                                className="digitInput"
                                onChange={(event) => handleABVTarget(event)}
                            />{" "}
                            %
                        </td>
                    </tr>
            ...
            <button
                onClick={() =>
                    resetAllFields(inputVolume, inputABV, targetABV, output)
                }
            >
                Reset
            </button>
            <table>
                <tbody>
                    <tr>
                        <td>Total LAA:</td>
                        <td>
                            {(inputVolume * (inputABV / 100)).toFixed(2)} LAA
                        </td>
                    </tr>
                    <tr>
                        <td>Required additions:</td>
                        <td>{output.toFixed(2)} liters</td>
                    </tr>
                    <tr>
                        <td>Final Volume:</td>
                        <td>{(output + inputVolume).toFixed(2)} liters</td>
                    </tr>
                </tbody>
            </table>
        </div>
